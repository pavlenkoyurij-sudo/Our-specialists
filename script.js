        ...
        const masters = [
...

           {
...

            {
                ...
                city: "Покров",
                phone: "+380976944195",
                description: "Дверні та замкові роботи:Встановлення або заміна замків, личинок, ручок на вхідних чи міжкімнатних дверях.Сантехнічні роботи:Усунення протікань, заміна змішувачів, підключення пральних чи посудомийних машин, заміна сифонів та труб. Електромонтажні роботи:Встановлення та заміна розеток, вимикачів, світильників, люстр та ремонт дрібної проводки. Дрібний ремонт меблів:Збирання нових меблів (шафи, ліжка, столи), регулювання дверцят, заміна фурнітури та ремонт висувних шухляд. Монтажні та кріпильні роботи:Навішування полиць, телевізорів, дзеркал, картин, жалюзі та карнизів.  Господарські дрібниці:Укладання плінтусів, монтаж порогів, навішування або зняття штор"
           },
